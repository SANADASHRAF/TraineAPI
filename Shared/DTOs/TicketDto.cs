...
namespace Shared.DTOs
{
   ...
   public record CreateTicketDto
    ...
    public record TicketDto(int Id, string? TrainNumber, int? NumOfSeat, DateTime TakeOffDate, string? TakeOffStation, string? ArrivalStation, double Price, string? TrainDegree, int? UserId, int? PaymentId);
